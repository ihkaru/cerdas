...
## [0.2.54](https://github.com/ihkaru/cerdas/compare/v0.2.53...v0.2.54) (2026-09-17)
...
* add APK download card to dashboard and auto-GitHub sync ([a214ecb](https://github.com/ihkaru/cerdas/commit/a214ecbe78f81119b464bca9f22ffb4f30e29afd))
...
* add support for multiselect checkbox field and ignore schema file ([61af30e](https://github.com/ihkaru/cerdas/commit/61af30e42b791c98c38bc8bce54dcfa7f0cfdb96))
...
* enforce app slug immutability during schema updates via code tab ([ebaa9ba](https://github.com/ihkaru/cerdas/commit/ebaa9ba210c524af2df4e73d33c3ac45e56aaf4e))
...
* implement dynamic origin API fallback and zero hardcoded ports for Coolify deployment (v0.2.24) ([c0d0f17](https://github.com/ihkaru/cerdas/commit/c0d0f1749cb94f9c29fc088ca3771630f008e8b6))
...
* v0.2.29 data scrubbing, required_if, UX hints, sampah improvements ([ab978bb](https://github.com/ihkaru/cerdas/commit/ab978bb75535c8cc18110a29ea16e36c6159e64a))
...
* **backend:** exclude inactive apps and their tables from surveyor dashboard sync ([7243e26](https://github.com/ihkaru/cerdas/commit/7243e2622357102ee66b84daf19c6b32528dfc56))
* **backend:** fallback view table slug to first table if unresolved ([726c0c0](https://github.com/ihkaru/cerdas/commit/726c0c0291d044485c0cca1be3e6c349df1b73be))
* **backend:** include fields/layout/settings in dashboard tables payload for client SQLite sync ([0b8db2c](https://github.com/ihkaru/cerdas/commit/0b8db2cb476d7136da233b727b7eb7d1b3c84467))
...
* **backend:** serialize empty tables and views as JSON objects ([50fa03b](https://github.com/ihkaru/cerdas/commit/50fa03b76a8bd88ab2854909f157eeb0bbdf766f))
...
* **backend:** use hasAppAccess instead of contains on array in AssignmentController destroy ([7a182b6](https://github.com/ihkaru/cerdas/commit/7a182b6d862363d9eac73fcc9ff15497cbb8e3dd))
* **backend:** use view_configs JSON column as source of truth for schema views ([ac3a269](https://github.com/ihkaru/cerdas/commit/ac3a2699ba7984c04236d173d2e6b93e23c8a172))
...
* **client:** align version to 0.2.48 — release please will bump to 0.2.49 ([4f92f39](https://github.com/ihkaru/cerdas/commit/4f92f39920d85df2265262f6acdcf8170696d6d6))
* **client:** bypass Framework7 router for external APK download links ([439ab5a](https://github.com/ihkaru/cerdas/commit/439ab5a0283afa0224706ae8184e1c27dcdd9290))
* **client:** compute downloadUrl dynamically based on latestVersion ([330f9ba](https://github.com/ihkaru/cerdas/commit/330f9ba34a9ce09378e3ead48aa780340d41c3db))
...
* **client:** ensure latestVersion uses currentVersion fallback if cached version is older ([377d034](https://github.com/ihkaru/cerdas/commit/377d034c987c42000335c2629d8f4210c3bc614c))
...
* **client:** fix FAB disappearing after sync - empty object truthy bug in cacheAndSaveTable ([8143252](https://github.com/ihkaru/cerdas/commit/8143252968496efe4f3da613bb36ca28e14abb3d))
...
* **client:** improve click gesture and add version tap debug console fallback ([1c2749f](https://github.com/ihkaru/cerdas/commit/1c2749f55de767d9c932daa505027eea28e6e5f3))
...
* **client:** pass resolvedTableId to useAppShellSync for preview mode data sync ([ab04174](https://github.com/ihkaru/cerdas/commit/ab04174b9c490bd4b0b9936f7cc3aa6271387425))
* **client:** prioritize VITE_API_URL and implement robust SQLite settings merge ([8df72c9](https://github.com/ihkaru/cerdas/commit/8df72c982e1c9b4263efd0717e9cdefc204e917c))
...
* **client:** remove legacy table fallbacks to implement fail-fast on invalid apps ([79951d4](https://github.com/ihkaru/cerdas/commit/79951d48f1a4db290bd3860a61bae1ef9fc360d3))
...
* **client:** replace hardcoded v0.2.7 version fallback with dynamic __APP_VERSION__ ([b067618](https://github.com/ihkaru/cerdas/commit/b067618fb1a1310d35e69158d4bbd9bf30fc4e38))
...
* **client:** sync all tables from app.tables relation to avoid missing view config tables ([5d15556](https://github.com/ihkaru/cerdas/commit/5d1555609596ef4e35997011bd9b7a8c386af7fc))
...
* **client:** wrap title in native span to ensure tap event registers correctly ([898ccdb](https://github.com/ihkaru/cerdas/commit/898ccdb52098b1c03205cd8ad0713988eeb277b5))
...
* **editor:** use crypto.randomUUID() to fix sonarjs/pseudo-random error ([c880962](https://github.com/ihkaru/cerdas/commit/c8809622b0526a52adc0d0a8f06b9e69e3d2c180))
...
* **image:** proxy image URLs in client and editor review drawer ([d5d7170](https://github.com/ihkaru/cerdas/commit/d5d71709447d1b79b277621e02720ff68563e32b))
...
* make nullable layout properties access in AppSchemaController safe to prevent 500 error ([22bf977](https://github.com/ihkaru/cerdas/commit/22bf9779a972a44857e944c093cf6450a35316b7))
...
* propagate views and navigation during app schema apply in editor ([e55ebfc](https://github.com/ihkaru/cerdas/commit/e55ebfc4ebfcab5e6e62c6d7363324ac1f61782a))
...
* **release:** disable component prefix in release tags ([f3eb6de](https://github.com/ihkaru/cerdas/commit/f3eb6de5e5a06f7bd2295f80367ffcf28e96f6b7))
...
* return a validation error instead of 500 when app slug is already taken ([9ed2231](https://github.com/ihkaru/cerdas/commit/9ed2231530b0fb62c72ae7c8873ec682fa21570a))
...
* **sync:** alert deactivations and enforce active app validation on response submissions ([defcf5c](https://github.com/ihkaru/cerdas/commit/defcf5ca726cb16ee0b4aadbc04a948050c20123))
...
* **sync:** support dataOnly sync option for entire app in preview mode ([01875d8](https://github.com/ihkaru/cerdas/commit/01875d8bf1b7e0883270f0429f101715479ab45b))
...
## [0.2.29](https://github.com/ihkaru/cerdas/compare/cerdas-v0.2.28...cerdas-v0.2.29) (2026-07-18)
