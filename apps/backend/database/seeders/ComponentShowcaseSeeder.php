...
class ComponentShowcaseSeeder extends Seeder {
    public function run(): void {
        ...
        $schemaDefinition = [
            'fields' => [
                ...
                [
                    ...
                    'type' => 'html_block',
                    'content' => '<h3>Family Members (Nested Form)</h3>'
                ],
                [
                    'name' => 'family_members',
        ...
        // 3. Create Schema Version (The Data Structure)
        ...
        $viewList = \App\Models\View::updateOrCreate(
        ...
        $viewMap = \App\Models\View::updateOrCreate(
