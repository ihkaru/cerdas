<template>
    <div class="app-settings-panel">
        ...
        <f7-list inset>
            ...
            <f7-list-input label="App Name" type="text" :value="schemaName" placeholder="My App"
                @input="updateSchemaName(($event.target as HTMLInputElement).value)" />
...
const {
    ...
    updateSettings,
    updateDescription,
    updateSchemaName: updateSchemaNameAction
} = useSchemaEditor();
...
function updateSchemaName(name: string) {
    updateSchemaNameAction(name);
}
