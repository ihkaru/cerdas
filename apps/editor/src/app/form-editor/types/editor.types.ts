...
export interface SchemaEditorState {
  /** Schema ID from backend (null for new schema) */
...
/** Configuration for App Actions (Header, Row, Swipe) */
...
/** App-level Settings stored in AppSchema.settings */
...
/** Layout Configuration stored in AppSchemaVersion.layout */
