<template>
  <f7-popup v-model:opened="isOpened" class="debug-popup">
    <f7-page>
...
.dbg-log-debug .dbg-log-level {
  color: #6272a4;
  background: rgba(98, 114, 164, 0.2);
}

.dbg-log-info .dbg-log-level {
  color: #50fa7b;
  background: rgba(80, 250, 123, 0.2);
}

.dbg-log-warn .dbg-log-level {
  color: #f1fa8c;
  background: rgba(241, 250, 140, 0.2);
}

.dbg-log-error .dbg-log-level {
  color: #ff5555;
  background: rgba(255, 85, 85, 0.2);
}

.dbg-log-error .dbg-log-msg {
  color: #ff5555;
}
</style>
