<template>
  <div class="field-box">
    ...
    <div class="input-wrapper">
      ...
      <!-- Editable Mode -->
      <input v-else ref="inputRef" class="custom-input" type="number" :placeholder="field.placeholder" @input="onInput"
        @blur="onBlur" :required="field.required" :min="field.min" :max="field.max" />
